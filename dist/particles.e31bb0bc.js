...
},{"./_baseRandom":"node_modules/lodash/_baseRandom.js","./_isIterateeCall":"node_modules/lodash/_isIterateeCall.js","./toFinite":"node_modules/lodash/toFinite.js"}],"node_modules/stats.js/build/stats.min.js":[function(require,module,exports) {
var define;
...
var particlesAmountController = gui.add(config, 'particles_amount', 1, 500).name('Particles amount');
...
var textController = gui.add(config, 'text').name('Text to draw');
var drawTextParticlesController = gui.add(config, 'draw_text_particles').name('Draw text particles');
particlesAmountController.onChange(function () {
  clearParticles();
  setup();
});
textController.onChange(function () {
  clearParticles();
  setup();
});
drawTextParticlesController.onChange(function () {
  clearParticles();
  setup();
});
...
function strokeText() {
  ...
  textCtx.strokeStyle = "rgb(".concat(config.line_color, ")");
...
function setup() {
  ...
  strokeText();
  addTextParticles(getTextBoundaryPixels().filter(takeEveryNthElement(10)));
}
...
function getRandomSpeed() {
  return (0, _random.default)(config.min_speed, config.max_speed);
}

function getRandomDirection() {
  return (0, _random.default)(0, 1) ? 1 : -1;
}

function drawParticle(x, y) {
  var color = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : config.particle_color;
  ctx.fillStyle = color;
...
function draw() {
  ...
  particles.forEach(function (particle) {
    var newX = particle.x + particle.speedX * particle.xDirection;
    var newY = particle.y + particle.speedY * particle.yDirection;
...
function connectParticles(particle1, particle2) {
  var distanceBetweenParticles = getDistanceBetweenParticles(particle1, particle2);

  if (distanceBetweenParticles > config.max_connecting_distance) {
    return;
  }

  var alpha = 1 - distanceBetweenParticles / config.max_connecting_distance;
  ctx.beginPath();
  ctx.strokeStyle = "rgba(".concat(config.line_color, ", ").concat(alpha, ")");
...
function findNearestParticles(particleStart) {
  var radius = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : config.max_connecting_distance;
  var nearestParticles = [];
  particles.forEach(function (particle) {
...
},{"dat.gui":"node_modules/dat.gui/build/dat.gui.module.js","lodash/random":"node_modules/lodash/random.js","stats.js":"node_modules/stats.js/build/stats.min.js"}],"../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
